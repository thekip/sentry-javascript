...
var Sentry = (function (t) {
  ...
  var c = {};
  function s() {
    return 'undefined' != typeof window ? window : 'undefined' != typeof self ? self : c;
  }
  ...
  function E(t, n) {
    try {
      for (
        var r = t, e = [], i = 0, o = 0, u = ' > '.length, a = void 0;
        r && i++ < 5 && !('html' === (a = S(r, n)) || (i > 1 && o + e.length * u + a.length >= 80));
  ...
  function S(t, n) {
    ...
    if (s && s.length)
      ...
      for (e = r.split(/\s+/), u = 0; u < e.length; u++) c.push('.' + e[u]);
    var f = ['type', 'name', 'title', 'alt'];
    for (u = 0; u < f.length; u++) (i = f[u]), (o = a.getAttribute(i)) && c.push('[' + i + '="' + o + '"]');
    return c.join('');
  }
  var k =
    Object.setPrototypeOf ||
  ...
  var _ = (function (t) {
      function n(n) {
        ...
        return (e.message = n), (e.name = r.prototype.constructor.name), k(e, r.prototype), e;
      }
      return r(n, t), n;
    })(Error),
    j = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w.-]+)(?::(\d+))?\/(.+)/;
  ...
  function D(t) {
    var n =
      'string' == typeof t
        ? (function (t) {
            var n = j.exec(t);
            if (!n) throw new _('Invalid Sentry Dsn: ' + t);
            var r = u(n.slice(1), 6),
              e = r[0],
              i = r[1],
              o = r[2],
            ...
            return T({ host: c, pass: a, path: h, projectId: v, port: f, protocol: e, publicKey: i });
          })(t)
        : T(t);
    return n;
  }
  ...
  var q = (function () {
    ...
    return (
      ...
      (t.prototype.error = function () {
        ...
        this.t &&
          M(function () {
            R.console.error(I + '[Error]: ' + t.join(' '));
          });
      }),
      t
    );
  ...
  var A = R.__SENTRY__.logger || (R.__SENTRY__.logger = new q());
  function C(t) {
    try {
  ...
  function P(t, n) {
    var r = n.prototype || {};
    (t.prototype = n.prototype = r), H(t, '__sentry_original__', n);
  }
  function X(t) {
  ...
  function B(t) {
    ...
    if (b(t)) {
      ...
      o.type = i.type;
      try {
        o.target = w(i.target) ? E(i.target) : Object.prototype.toString.call(i.target);
      } catch (t) {
        o.target = '<unknown>';
      }
      try {
        o.currentTarget = w(i.currentTarget) ? E(i.currentTarget) : Object.prototype.toString.call(i.currentTarget);
      } catch (t) {
        o.currentTarget = '<unknown>';
      }
      for (var u in ('undefined' != typeof CustomEvent && x(t, CustomEvent) && (o.detail = i.detail), i))
  ...
  function G(t, n, r, e) {
    ...
    var a = B(n),
      c = Array.isArray(n) ? [] : {};
    if (e[0](n)) return '[Circular ~]';
    for (var s in a) Object.prototype.hasOwnProperty.call(a, s) && (c[s] = G(s, a[s], r - 1, e));
    return e[1](n), c;
  }
  function K(t, n) {
    try {
  ...
  function V(t, n) {
    ...
    if (r[0].length >= n) return L(r[0], n);
    for (var e = r.length; e > 0; e--) {
      var i = r.slice(0, e).join(', ');
      if (!(i.length > n)) return e === r.length ? i : L(i, n);
    }
    return '';
  }
  function Q(t) {
    ...
    if (m(t)) {
      var e = t,
        i = {};
      try {
        for (var u = o(Object.keys(e)), a = u.next(); !a.done; a = u.next()) {
          var c = a.value;
          void 0 !== e[c] && (i[c] = Q(e[c]));
        }
      } catch (t) {
        n = { error: t };
      } finally {
      ...
      switch (((it[t] = !0), t)) {
        case 'console':
          !(function () {
            ...
            ['debug', 'info', 'warn', 'error', 'log', 'assert'].forEach(function (t) {
              t in rt.console &&
                F(rt.console, t, function (n) {
                  return function () {
                    for (var r = [], e = 0; e < arguments.length; e++) r[e] = arguments[e];
                    at('console', { args: r, level: t }), n && Function.prototype.apply.call(n, rt.console, r);
                  };
                });
            });
          })();
        ...
        case 'dom':
          !(function () {
            ...
            var t = at.bind(null, 'dom'),
              n = vt(t, !0);
            rt.document.addEventListener('click', n, !1),
              rt.document.addEventListener('keypress', n, !1),
              ['EventTarget', 'Node'].forEach(function (n) {
                var r = rt[n] && rt[n].prototype;
                r &&
                  r.hasOwnProperty &&
                  r.hasOwnProperty('addEventListener') &&
                  (F(r, 'addEventListener', function (n) {
                  ...
                  F(r, 'removeEventListener', function (t) {
                    return function (n, r, e) {
                      if ('click' === n || 'keypress' == n)
                        try {
                          ...
                          o &&
                            ((o.refCount -= 1),
                            o.refCount <= 0 && (t.call(this, n, o.handler, e), (o.handler = void 0), delete i[n]),
          ...
          !(function () {
            ...
            F(t, 'open', function (t) {
              return function () {
                ...
                var e = this,
                  i = n[1],
                  o = (e.__sentry_xhr__ = { method: p(n[0]) ? n[0].toUpperCase() : n[0], url: n[1] });
                ...
                var u = function () {
                  if (4 === e.readyState) {
                    ...
                    at('xhr', { args: n, endTimestamp: Date.now(), startTimestamp: Date.now(), xhr: e });
                  }
                };
                return (
                  'onreadystatechange' in e && 'function' == typeof e.onreadystatechange
                    ? F(e, 'onreadystatechange', function (t) {
                        return function () {
                          for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
              ...
              F(t, 'send', function (t) {
                return function () {
                  ...
                  return (
                    ...
                    at('xhr', { args: n, startTimestamp: Date.now(), xhr: this }),
                    t.apply(this, n)
                  );
                };
              });
        ...
        case 'fetch':
          !(function () {
            if (
                ...
                if (r && 'function' == typeof r.createElement)
                  try {
                    ...
                    (e.hidden = !0),
                      ...
                      e.contentWindow && e.contentWindow.fetch && (n = Z(e.contentWindow.fetch)),
              ...
              return;
            F(rt, 'fetch', function (t) {
              return function () {
                for (var n = [], r = 0; r < arguments.length; r++) n[r] = arguments[r];
                var e = { args: n, fetchData: { method: ct(n), url: st(n) }, startTimestamp: Date.now() };
                return (
                  at('fetch', i({}, e)),
                  t.apply(rt, n).then(
                    function (t) {
                      return at('fetch', i(i({}, e), { endTimestamp: Date.now(), response: t })), t;
                    },
                    function (t) {
                      throw (at('fetch', i(i({}, e), { endTimestamp: Date.now(), error: t })), t);
                    },
                  )
                );
              };
          ...
          !(function () {
            ...
            (rt.onpopstate = function () {
              ...
              var e = rt.location.href,
                i = nt;
              if (((nt = e), at('history', { from: i, to: e }), t))
                try {
                  return t.apply(this, n);
                } catch (t) {}
            }),
              F(rt.history, 'pushState', n),
              F(rt.history, 'replaceState', n);
          })();
          break;
        case 'error':
          (lt = rt.onerror),
            (rt.onerror = function (t, n, r, e, i) {
              return at('error', { column: e, error: i, line: r, msg: t, url: n }), !!lt && lt.apply(this, arguments);
            });
          break;
        case 'unhandledrejection':
          (dt = rt.onunhandledrejection),
            (rt.onunhandledrejection = function (t) {
              return at('unhandledrejection', t), !dt || dt.apply(this, arguments);
            });
          break;
        default:
  ...
  function ut(t, n) {
    (et[t] = et[t] || []), et[t].push(n), ot(t);
  }
  function at(t, n) {
    var r, e;
    if (t && et[t])
      try {
        for (var i = o(et[t] || []), u = i.next(); !u.done; u = i.next()) {
          var a = u.value;
          try {
            a(n);
          } catch (t) {
  ...
  function ct(t) {
    return (
      void 0 === t && (t = []),
      'Request' in rt && x(t[0], Request) && t[0].method
  ...
  function st(t) {
    return (
      void 0 === t && (t = []),
      'string' == typeof t[0] ? t[0] : 'Request' in rt && x(t[0], Request) ? t[0].url : String(t[0])
    );
  }
  var ft, ht;
  function vt(t, n) {
      ...
      function (r) {
        if (
          ...
          (void 0 === ft ||
            ...
            (t({ event: r, name: e, global: n }), (ht = r)),
            clearTimeout(ft),
            (ft = rt.setTimeout(function () {
              ft = void 0;
            }, 1e3));
        }
      }
  ...
  function gt(t, n) {
    ...
    if (r) {
      var e = r.mechanism;
      if (((r.mechanism = i(i(i({}, { type: 'generic', handled: !0 }), e), n)), n && 'data' in n)) {
  ...
  var kt = (function () {
    function t(t) {
      ...
      (this.o = 0),
        ...
        (this.h = function (t, r) {
          0 === n.o && (g(r) ? r.then(n.s, n.v) : ((n.o = t), (n.l = r), n.p()));
        }),
        (this.p = function () {
          if (0 !== n.o) {
            var t = n.u.slice();
            (n.u = []),
              t.forEach(function (t) {
                t[0] || (1 === n.o && t[1](n.l), 2 === n.o && t[2](n.l), (t[0] = !0));
              });
          }
        });
      try {
  ...
  function _t(t) {
    ...
    return {
      $: n,
      add: function (e) {
        if (!(void 0 === t || n.length < t)) return St(new _('Not adding Promise due to buffer limit reached.'));
        var i = e();
        return (
  ...
  var Tt = (function () {
    ...
    Nt = Ot.nowSeconds.bind(Ot),
    Rt = Dt.nowSeconds.bind(Dt),
    It =
      ((function () {
        var t = s().performance;
        if (t && t.now) {
      ...
      (function () {
        ...
        return (
          ...
          (t.prototype.setUser = function (t) {
            return (this._ = t || {}), this.I && this.I.update({ user: t }), this.C(), this;
          }),
          ...
          (t.prototype.setTags = function (t) {
            return (this.j = i(i({}, this.j), t)), this.C(), this;
          }),
          (t.prototype.setTag = function (t, n) {
            var r;
            return (this.j = i(i({}, this.j), (((r = {})[t] = n), r))), this.C(), this;
          }),
          (t.prototype.setExtras = function (t) {
            return (this.O = i(i({}, this.O), t)), this.C(), this;
          }),
          (t.prototype.setExtra = function (t, n) {
            var r;
            return (this.O = i(i({}, this.O), (((r = {})[t] = n), r))), this.C(), this;
          }),
          (t.prototype.setFingerprint = function (t) {
            return (this.q = t), this.C(), this;
          }),
          (t.prototype.setLevel = function (t) {
            return (this.N = t), this.C(), this;
          }),
          (t.prototype.setTransactionName = function (t) {
            return (this.M = t), this.C(), this;
          }),
          ...
          (t.prototype.setContext = function (t, n) {
            var r;
            return null === n ? delete this.T[t] : (this.T = i(i({}, this.T), (((r = {})[t] = n), r))), this.C(), this;
          }),
          (t.prototype.setSpan = function (t) {
            return (this.R = t), this.C(), this;
          }),
          ...
          (t.prototype.setSession = function (t) {
            return t ? (this.I = t) : delete this.I, this.C(), this;
          }),
          ...
          (t.prototype.update = function (n) {
            ...
            return (
              n instanceof t
                ? ((this.j = i(i({}, this.j), n.j)),
                  (this.O = i(i({}, this.O), n.O)),
                  (this.T = i(i({}, this.T), n.T)),
                  n._ && Object.keys(n._).length && (this._ = n._),
                  n.N && (this.N = n.N),
                  n.q && (this.q = n.q),
                  n.A && (this.A = n.A))
                : m(n) &&
                  ...
                  n.user && (this._ = n.user),
                  n.level && (this.N = n.level),
                  n.fingerprint && (this.q = n.fingerprint),
          ...
          (t.prototype.addBreadcrumb = function (t, n) {
            ...
            if (r <= 0) return this;
            var e = i({ timestamp: Nt() }, t);
            return (this.k = a(this.k, [e]).slice(-r)), this.C(), this;
          }),
          (t.prototype.clearBreadcrumbs = function () {
            return (this.k = []), this.C(), this;
          }),
          (t.prototype.applyToEvent = function (t, n) {
            if (
              (this.O && Object.keys(this.O).length && (t.extra = i(i({}, this.O), t.extra)),
              this.j && Object.keys(this.j).length && (t.tags = i(i({}, this.j), t.tags)),
              this._ && Object.keys(this._).length && (t.user = i(i({}, this._), t.user)),
              this.T && Object.keys(this.T).length && (t.contexts = i(i({}, this.T), t.contexts)),
              this.N && (t.level = this.N),
              this.M && (t.transaction = this.M),
              this.R)
            ) {
              t.contexts = i({ trace: this.R.getTraceContext() }, t.contexts);
              var r = this.R.transaction && this.R.transaction.name;
              r && (t.tags = i({ transaction: r }, t.tags));
            }
            return (
              this.L(t),
              (t.breadcrumbs = a(t.breadcrumbs || [], this.k)),
              (t.breadcrumbs = t.breadcrumbs.length > 0 ? t.breadcrumbs : void 0),
              (t.sdkProcessingMetadata = this.D),
              this.U(a(Mt(), this.S), t, n)
            );
          }),
          (t.prototype.setSDKProcessingMetadata = function (t) {
            return (this.D = i(i({}, this.D), t)), this;
          }),
          ...
          (t.prototype.L = function (t) {
            (t.fingerprint = t.fingerprint ? (Array.isArray(t.fingerprint) ? t.fingerprint : [t.fingerprint]) : []),
              this.q && (t.fingerprint = t.fingerprint.concat(this.q)),
      ...
      return (
        (t.prototype.update = function (t) {
          if (
            ...
            t.sid && (this.sid = 32 === t.sid.length ? t.sid : pt()),
    ...
    Ct = (function () {
      ...
      return (
        ...
        (t.prototype.captureException = function (t, n) {
          ...
          return this.P('captureException', t, i(i({}, e), { event_id: r })), r;
        }),
        (t.prototype.captureMessage = function (t, n, r) {
          ...
          return this.P('captureMessage', t, n, i(i({}, o), { event_id: e })), e;
        }),
        (t.prototype.captureEvent = function (t, n) {
          var r = pt();
          return 'transaction' !== t.type && (this.H = r), this.P('captureEvent', t, i(i({}, n), { event_id: r })), r;
        }),
        ...
        (t.prototype.getIntegration = function (t) {
          ...
          try {
            ...
            return A.warn('Cannot retrieve integration ' + t.id + ' from the current Hub'), null;
          }
        }),
        ...
        (t.prototype.endSession = function () {
          var t = this.getStackTop(),
            n = t && t.scope,
            r = n && n.getSession();
          r && r.close(), this.B(), n && n.setSession();
        }),
        (t.prototype.startSession = function (t) {
          var n = this.getStackTop(),
            ...
            f = new At(i(i(i({ release: u, environment: a }, r && { user: r.getUser() }), c && { userAgent: c }), t));
          if (r) {
            var h = r.getSession && r.getSession();
            h && 'ok' === h.status && h.update({ status: 'exited' }), this.endSession(), r.setSession(f);
          }
          return f;
        }),
        ...
        (t.prototype.X = function (t) {
          ...
          A.warn('Extension method ' + t + " couldn't be found, doing nothing.");
        }),
        t
      );
    })();
  ...
  function Jt() {
    var t = Lt();
    return (Ft(t) && !Ht(t).isOlderThan(4)) || Pt(t, new Ct()), Ht(t);
  }
  function Ft(t) {
  ...
  function Ht(t) {
    return (
      (t && t.__SENTRY__ && t.__SENTRY__.hub) || ((t.__SENTRY__ = t.__SENTRY__ || {}), (t.__SENTRY__.hub = new Ct())),
      t.__SENTRY__.hub
    );
  }
  function Pt(t, n) {
    ...
    return (
      (function (t) {
        ...
        Array.isArray(r)
          ...
          : 'function' == typeof r && ((e = r(e)), (e = Array.isArray(e) ? e : [e]));
        var i = e.map(function (t) {
          return t.name;
        });
        return -1 !== i.indexOf('Debug') && e.push.apply(e, a(e.splice(i.indexOf('Debug'), 1))), e;
      })(t).forEach(function (t) {
        (n[t.name] = t),
          (function (t) {
            -1 === Vt.indexOf(t.name) &&
              (t.setupOnce(qt, Jt), Vt.push(t.name), A.log('Integration installed: ' + t.name));
          })(t);
      }),
      H(n, 'initialized', !0),
      n
  ...
  var Zt = "Not capturing exception because it's already been captured.",
    tn = (function () {
      function t(t, n) {
        (this.W = {}), (this.G = 0), (this.K = new t(n)), (this.V = n), n.dsn && (this.Y = D(n.dsn));
      }
      return (
        ...
        (t.prototype.captureEvent = function (t, n, r) {
          if (!(n && n.originalException && xt(n.originalException))) {
            var e = n && n.event_id;
            return (
              this.Z(
                this.nt(t, n, r).then(function (t) {
                  e = t;
                }),
              ),
              e
        ...
        (t.prototype.captureSession = function (t) {
          this.rt() && ('string' != typeof t.release || (this.et(t), t.update({ init: !1 })));
        }),
        ...
        (t.prototype.setupIntegrations = function () {
          this.rt() && !this.W.initialized && (this.W = Yt(this.V));
        }),
        (t.prototype.getIntegration = function (t) {
          try {
            return this.W[t.id] || null;
          } catch (n) {
            return A.warn('Cannot retrieve integration ' + t.id + ' from the current Client'), null;
          }
        }),
        (t.prototype.ot = function (t, n) {
          ...
          var v = 'ok' === t.status;
          ((v && 0 === t.errors) || (v && u)) &&
            (t.update(i(i({}, u && { status: 'crashed' }), { errors: t.errors || Number(a || u) })),
          ...
          return new kt(function (r) {
            var e = 0,
              i = setInterval(function () {
                0 == n.G ? (clearInterval(i), r(!0)) : ((e += 1), t && e >= t && (clearInterval(i), r(!1)));
              }, 1);
          });
        }),
        ...
        (t.prototype.ut = function (t, n, r) {
          var e = this,
            ...
            u = void 0 === o ? 3 : o,
            a = i(i({}, t), {
              event_id: t.event_id || (r && r.event_id ? r.event_id : pt()),
              timestamp: t.timestamp || Nt(),
            });
          this.at(a), this.ct(a);
          var c = n;
          r && r.captureContext && (c = It.clone(c).update(r.captureContext));
          var s = Et(a);
          return (
            c && (s = c.applyToEvent(a, r)),
            s.then(function (t) {
              return 'number' == typeof u && u > 0 ? e.st(t, u) : t;
            })
          );
        }),
                ...
                i(
                  ...
                  t.breadcrumbs && {
                    breadcrumbs: t.breadcrumbs.map(function (t) {
                      return i(i({}, t), t.data && { data: K(t.data, n) });
                    }),
                  },
                ),
                t.user && { user: K(t.user, n) },
              ),
              t.contexts && { contexts: K(t.contexts, n) },
            ),
            t.extra && { extra: K(t.extra, n) },
          );
          return (
            t.contexts && t.contexts.trace && (r.contexts.trace = t.contexts.trace),
            (t.sdkProcessingMetadata = i(i({}, t.sdkProcessingMetadata), { baseClientNormalized: !0 })),
            r
          );
        }),
        (t.prototype.at = function (t) {
          ...
          'environment' in t || (t.environment = 'environment' in n ? r : 'production'),
            ...
            t.message && (t.message = L(t.message, u));
          var a = t.exception && t.exception.values && t.exception.values[0];
          a && a.value && (a.value = L(a.value, u));
          var c = t.request;
          c && c.url && (c.url = L(c.url, u));
        }),
        (t.prototype.ct = function (t) {
          var n = Object.keys(this.W);
        ...
        (t.prototype.ht = function (t, n, r) {
          ...
          if (!this.rt()) return St(new _('SDK not enabled, will not capture event.'));
          var s = 'transaction' === t.type;
          return !s && 'number' == typeof u && Math.random() > u
            ? (c('sample_rate', 'event'),
              St(new _("Discarding event because it's not included in the random sample (sampling rate = " + u + ')')))
            : this.ut(t, r, n)
                .then(function (r) {
                  if (null === r)
                    throw (
                      (c('event_processor', t.type || 'event'),
                      new _('An event processor returned null, will not send event.'))
                    );
                ...
                .then(function (n) {
                  if (null === n)
                    throw (
                      (c('before_send', t.type || 'event'), new _('`beforeSend` returned `null`, will not send event.'))
                    );
                  var i = r && r.getSession && r.getSession();
                  return !s && i && e.ot(i, n), e.ft(n), n;
                })
                .then(null, function (t) {
                  if (t instanceof _) throw t;
                  throw (
                    (e.captureException(t, { data: { __sentry__: !0 }, originalException: t }),
                    new _(
  ...
  var nn = (function () {
    ...
    rn = (function () {
      function t(t) {
        (this.V = t), this.V.dsn || A.warn('No DSN provided, backend will not do anything.'), (this.vt = this.lt());
      }
      return (
  ...
  function on(t, n) {
    ...
    var v = { body: r, type: o, url: u ? Kt(n.dsn, n.tunnel) : Gt(n.dsn) };
    if (u) {
      var l =
        JSON.stringify(
          i(
            i({ event_id: t.event_id, sent_at: new Date().toISOString() }, e && { sdk: e }),
  ...
  var un,
    ...
    sn = (function () {
      ...
      return (
        (t.prototype.setupOnce = function () {
          qt(function (n) {
            ...
            if (e) {
              var i = r.getClient(),
                o = i ? i.getOptions() : {},
                u = 'function' == typeof e._mergeOptions ? e._mergeOptions(o) : {};
              return 'function' != typeof e.dt ? n : e.dt(n, u) ? null : n;
            }
            return n;
          });
        }),
        (t.prototype.dt = function (t, n) {
          return !!this.pt(t, n) || !!this.yt(t, n) || !!this.bt(t, n) || !this.wt(t, n);
        }),
        ...
        (t.prototype.xt = function (t) {
          try {
            if (t.stacktrace) return this.Et(t.stacktrace.frames);
            var n;
            try {
              n = t.exception.values[0].stacktrace.frames;
            } catch (t) {}
            return n ? this.Et(n) : null;
          } catch (t) {
            return null;
          }
        }),
    ...
    fn = Object.freeze({ __proto__: null, FunctionToString: an, InboundFilters: sn }),
    hn =
      ...
      if (
        (n = (function (t) {
          ...
          for (
            ...
            var c = null;
            (n = e.exec(o[a]))
              ? (c = { url: n[2], func: n[3], args: [], line: +n[1], column: null })
              : (n = i.exec(o[a])) &&
                (c = { url: n[6], func: n[3] || n[4], args: n[5] ? n[5].split(',') : [], line: +n[1], column: +n[2] }),
              c && (!c.func && c.line && (c.func = '?'), u.push(c));
          }
          if (!u.length) return null;
          return { message: gn(t), name: t.name, stack: u };
        })(t))
      )
        return wn(n, r);
    } catch (t) {}
    try {
      if (
        (n = (function (t) {
          ...
          for (var e, i, o, a = [], c = t.stack.split('\n'), s = 0; s < c.length; ++s) {
            if ((i = hn.exec(c[s]))) {
              var f = i[2] && 0 === i[2].indexOf('native');
              i[2] &&
                0 === i[2].indexOf('eval') &&
                (e = pn.exec(i[2])) &&
                ((i[2] = e[1]), (i[3] = e[2]), (i[4] = e[3]));
              var h = i[2] && 0 === i[2].indexOf('address at ') ? i[2].substr('address at '.length) : i[2],
                v = i[1] || '?';
              (n = u(bn(v, h), 2)),
                (v = n[0]),
                (h = n[1]),
            ...
            } else if ((i = ln.exec(c[s])))
              o = { url: i[2], func: i[1] || '?', args: [], line: +i[3], column: i[4] ? +i[4] : null };
            else {
              if (!(i = vn.exec(c[s]))) continue;
              i[3] && i[3].indexOf(' > eval') > -1 && (e = dn.exec(i[3]))
                ? ((i[1] = i[1] || 'eval'), (i[3] = e[1]), (i[4] = e[2]), (i[5] = ''))
                : 0 !== s || i[5] || void 0 === t.columnNumber || (a[0].column = t.columnNumber + 1);
              (h = i[3]), (v = i[1] || '?');
              (r = u(bn(v, h), 2)),
                (v = r[0]),
                (h = r[1]),
          ...
          return { message: gn(t), name: t.name, stack: a };
        })(t))
      )
        return wn(n, r);
    } catch (t) {}
    return { message: gn(t), name: t && t.name, stack: [], failed: !0 };
  }
  var bn = function (t, n) {
    var r = -1 !== t.indexOf('safari-extension'),
      e = -1 !== t.indexOf('safari-web-extension');
    return r || e
      ? [-1 !== t.indexOf('@') ? t.split('@')[0] : '?', r ? 'safari-extension:' + n : 'safari-web-extension:' + n]
      : [t, n];
  };
  function wn(t, n) {
    try {
      return i(i({}, t), { stack: t.stack.slice(n) });
    } catch (n) {
      return t;
    }
  }
  ...
  function kn(n, r, e) {
    var i = jn(r, (e && e.syntheticException) || void 0, { attachStacktrace: n.attachStacktrace });
    return gt(i), (i.level = t.Severity.Error), e && e.event_id && (i.event_id = e.event_id), Et(i);
  }
  function _n(n, r, e, i) {
    void 0 === e && (e = t.Severity.Info);
    var o = On(r, (i && i.syntheticException) || void 0, { attachStacktrace: n.attachStacktrace });
    return (o.level = e), i && i.event_id && (o.event_id = i.event_id), Et(o);
  }
  function jn(t, n, r) {
    var e;
    if ((void 0 === r && (r = {}), l(t) && t.error)) return (e = En(mn((t = t.error))));
    if (d(t) || v(t, 'DOMException')) {
      var o = t;
      if ('stack' in t) e = En(mn(t));
      else {
        var u = o.name || (d(o) ? 'DOMError' : 'DOMException'),
          a = o.message ? u + ': ' + o.message : u;
        wt((e = On(a, n, r)), a);
      }
      return 'code' in o && (e.tags = i(i({}, e.tags), { 'DOMException.code': '' + o.code })), e;
    }
    return h(t)
      ? (e = En(mn(t)))
      : m(t) || b(t)
      ? (gt(
                ...
                values: [
                  {
                    ...
                    value: 'Non-Error ' + (r ? 'promise rejection' : 'exception') + ' captured with keys: ' + V(t),
                  },
                ],
              },
              extra: { __serialized__: $(t) },
            };
            if (n) {
              var i = Sn(mn(n).stack);
        ...
        e)
      : (wt((e = On(t, n, r)), '' + t, void 0), gt(e, { synthetic: !0 }), e);
  }
  function On(t, n, r) {
    void 0 === r && (r = {});
    var e = { message: t };
  ...
  function Nn() {
    if (Tn) return Tn;
    if (Z(Dn.fetch)) return (Tn = Dn.fetch.bind(Dn));
    var t = Dn.document,
      n = Dn.fetch;
  ...
  function Rn(t, n) {
    if (
      '[object Navigator]' === Object.prototype.toString.call(Dn && Dn.navigator) &&
      'function' == typeof Dn.navigator.sendBeacon
    )
      return Dn.navigator.sendBeacon.bind(Dn.navigator)(t, n);
    if (Y()) {
      var r = Nn();
  ...
  var Mn = s(),
    qn = (function () {
      function t(t) {
        ...
        (this.options = t),
          ...
          (this._t = {}),
          (this.jt =
            ((n = t.dsn), (r = t.Ot), (e = t.tunnel), { initDsn: n, metadata: r || {}, dsn: D(n), tunnel: e })),
          (this.url = Gt(this.jt.dsn)),
          this.options.sendClientReports &&
            Mn.document &&
            Mn.document.addEventListener('visibilitychange', function () {
              'hidden' === Mn.document.visibilityState && i.Tt();
            });
      }
      return (
        (t.prototype.sendEvent = function (t) {
          return this.Dt(on(t, this.jt), t);
        }),
        (t.prototype.sendSession = function (t) {
          return this.Dt(
            (function (t, n) {
              ...
              return {
                body:
                  JSON.stringify(
                    i(i({ sent_at: new Date().toISOString() }, r && { sdk: r }), !!n.tunnel && { dsn: O(n.dsn) }),
                  ) +
                  '\n' +
        ...
        (t.prototype.recordLostEvent = function (t, n) {
          ...
          if (this.options.sendClientReports) {
            var e = In(n) + ':' + t;
            A.log('Adding outcome: ' + e), (this._t[e] = (null != (r = this._t[e]) ? r : 0) + 1);
          }
        }),
        (t.prototype.Tt = function () {
          if (this.options.sendClientReports) {
            var t = this._t;
            if (((this._t = {}), Object.keys(t).length)) {
              A.log('Flushing outcomes:\n' + JSON.stringify(t, null, 2));
              var n = Kt(this.jt.dsn, this.jt.tunnel),
                r =
                  JSON.stringify(i({}, this.jt.tunnel && { dsn: O(this.jt.dsn) })) +
                  '\n' +
                  ...
                  JSON.stringify({
                    ...
                    discarded_events: Object.keys(t).map(function (n) {
                      var r = u(n.split(':'), 2),
                        e = r[0];
                      return { reason: r[1], category: e, quantity: t[n] };
                    }),
                  });
              try {
                Rn(n, r);
          ...
          var n,
            ...
            u =
              (n = r.status) >= 200 && n < 300
                ...
                : 'unknown';
          this.Rt(e);
          'success' !== u ? o(r) : i({ status: u });
        }),
        (t.prototype.It = function (t) {
          var n = In(t);
          return this.kt[n] || this.kt.all;
        }),
        (t.prototype.Mt = function (t) {
          return this.It(t) > new Date(Date.now());
        }),
        (t.prototype.Rt = function (t) {
          ...
          if (a) {
            try {
              for (var s = o(a.trim().split(',')), f = s.next(); !f.done; f = s.next()) {
                var h = f.value.split(':', 2),
                  v = parseInt(h[0], 10),
                  l = 1e3 * (isNaN(v) ? 60 : v);
                try {
                  for (var d = ((e = void 0), o(h[1].split(';'))), p = d.next(); !p.done; p = d.next()) {
                    var y = p.value;
                    this.kt[y || 'all'] = new Date(u + l);
                  }
                } catch (t) {
                  e = { error: t };
                } finally {
          ...
          if (this.Mt(t.type))
            return (
              ...
              Promise.reject({
                ...
                type: t.type,
                reason:
                  'Transport for ' + t.type + ' requests locked till ' + this.It(t.type) + ' due to too many requests.',
                status: 429,
              })
            );
          var e = { body: t.body, method: 'POST', referrerPolicy: tt() ? 'origin' : '' };
          return (
            void 0 !== this.options.fetchParameters && Object.assign(e, this.options.fetchParameters),
              ...
              return new kt(function (n, i) {
                r.qt(t.url, e)
                  .then(function (e) {
                    ...
                    r.Nt({ requestType: t.type, response: e, headers: o, resolve: n, reject: i });
                  })
                  .catch(i);
              });
                ...
                return new kt(function (n, e) {
                  ...
                  for (var o in ((i.onreadystatechange = function () {
                    if (4 === i.readyState) {
                      ...
                      r.Nt({ requestType: t.type, response: i, headers: o, resolve: n, reject: e });
                    }
                  }),
                  i.open('POST', t.url),
                  r.options.headers))
                    Object.prototype.hasOwnProperty.call(r.options.headers, o) &&
    ...
    Ln = Object.freeze({ __proto__: null, BaseTransport: qn, FetchTransport: An, XHRTransport: Cn }),
    Un = (function (n) {
      function e() {
      ...
      return (
        ...
        (e.prototype.eventFromException = function (t, n) {
          return kn(this.V, t, n);
        }),
        (e.prototype.eventFromMessage = function (n, r, e) {
          return void 0 === r && (r = t.Severity.Info), _n(this.V, n, r, e);
        }),
        (e.prototype.lt = function () {
          if (!this.V.dsn) return n.prototype.lt.call(this);
          ...
          return this.V.transport ? new this.V.transport(t) : Y() ? new An(t) : new Cn(t);
        }),
        e
      );
    })(rn),
  ...
  function Xn(t, n, r) {
        ...
        throw (
          ...
          Bt(function (r) {
            r.addEventProcessor(function (t) {
              return (
                n.mechanism && (wt(t, void 0, void 0), gt(t, n.mechanism)),
                (t.extra = i(i({}, t.extra), { arguments: e })),
                t
              );
            }),
              captureException(t);
    ...
    P(sentryWrapped, t), H(t, '__sentry_wrapped__', sentryWrapped);
    try {
  ...
  function Bn(t) {
    if ((void 0 === t && (t = {}), Jn.document && t.eventId && t.dsn)) {
      var n = Jn.document.createElement('script');
      (n.async = !0),
        (n.src = (function (t, n) {
          var r = D(t),
            e = Wt(r) + 'embed/error-page/',
            i = 'dsn=' + O(r);
          for (var o in n)
            if ('dsn' !== o)
              if ('user' === o) {
      ...
      var r = Jn.document.head || Jn.document.body;
      r && r.appendChild(n);
    }
  }
  var Wn = (function () {
    function t(n) {
      (this.name = t.id),
        (this.At = { onerror: $n, onunhandledrejection: zn }),
        (this.V = i({ onerror: !0, onunhandledrejection: !0 }, n));
    }
    return (
      (t.prototype.setupOnce = function () {
  ...
  function $n() {
    ut('error', function (n) {
      var r = u(Qn(), 2),
        e = r[0],
        i = r[1];
      if (e.getIntegration(Wn)) {
        var o = n.msg,
          a = n.url,
          c = n.line,
          s = n.column,
          f = n.error;
        if (!(Hn() || (f && f.__sentry_own_request__))) {
          var h =
            void 0 === f && p(o)
              ? (function (t, n, r, e) {
                  ...
                  u && ((o = u[1]), (i = u[2]));
                  return Gn({ exception: { values: [{ type: o, value: i }] } }, n, r, e);
                })(o, a, c, s)
              : Gn(jn(f || o, void 0, { attachStacktrace: i, isRejection: !1 }), a, c, s);
          (h.level = t.Severity.Error), Vn(e, f, h, 'onerror');
        }
      }
    });
  }
  function zn() {
    ut('unhandledrejection', function (n) {
      var r = u(Qn(), 2),
        e = r[0],
        i = r[1];
      if (e.getIntegration(Wn)) {
        ...
        var a = y(o)
          ...
          : jn(o, void 0, { attachStacktrace: i, isRejection: !0 });
        (a.level = t.Severity.Error), Vn(e, o, a, 'onunhandledrejection');
      }
    });
  }
  function Gn(t, n, r, e) {
    ...
    return 0 === c.length && c.push({ colno: f, filename: v, function: '?', in_app: !0, lineno: h }), t;
  }
  function Kn(t) {
    0;
  }
  function Vn(t, n, r, e) {
    gt(r, { handled: !1, type: e }), t.captureEvent(r, { originalException: n });
  }
  function Qn() {
    var t = Jt(),
      n = t.getClient();
  ...
  var Yn = [
    ...
    Zn = (function () {
      ...
      return (
        (t.prototype.setupOnce = function () {
          var t = s();
          this.V.setTimeout && F(t, 'setTimeout', tr),
            this.V.setInterval && F(t, 'setInterval', tr),
            this.V.requestAnimationFrame && F(t, 'requestAnimationFrame', nr),
            this.V.XMLHttpRequest && 'XMLHttpRequest' in t && F(XMLHttpRequest.prototype, 'send', rr);
          var n = this.V.eventTarget;
          n && (Array.isArray(n) ? n : Yn).forEach(er);
        }),
        (t.id = 'TryCatch'),
        t
      );
  ...
  function tr(t) {
    return function () {
      ...
      var e = n[0];
      return (
        (n[0] = Xn(e, { mechanism: { data: { function: C(t) }, handled: !0, type: 'instrument' } })), t.apply(this, n)
      );
    };
  }
  function nr(t) {
    return function (n) {
      return t.call(
        this,
        Xn(n, {
          mechanism: { data: { function: 'requestAnimationFrame', handler: C(t) }, handled: !0, type: 'instrument' },
        }),
      );
    };
  }
      ...
      return (
        i.forEach(function (t) {
          t in e &&
            'function' == typeof e[t] &&
            F(e, t, function (n) {
              var r = { mechanism: { data: { function: t, handler: C(n) }, handled: !0, type: 'instrument' } },
                e = X(n);
              return e && (r.mechanism.data.handler = C(e)), Xn(n, r);
            });
        }),
        t.apply(this, n)
      );
      ...
      (F(r, 'addEventListener', function (n) {
        return function (r, e, i) {
          try {
            'function' == typeof e.handleEvent &&
              (e.handleEvent = Xn(e.handleEvent.bind(e), {
                mechanism: {
                  data: { function: 'handleEvent', handler: C(e), target: t },
                  handled: !0,
                  type: 'instrument',
                },
              }));
          ...
          return n.call(
            ...
            Xn(e, {
              mechanism: {
                data: { function: 'addEventListener', handler: C(e), target: t },
                handled: !0,
                type: 'instrument',
              },
            }),
  ...
  var ir = (function () {
    function t(n) {
      (this.name = t.id), (this.V = i({ console: !0, dom: !0, fetch: !0, history: !0, sentry: !0, xhr: !0 }, n));
    }
    return (
      ...
      (t.prototype.setupOnce = function () {
        ...
        this.V.console && ut('console', or),
          ...
          this.V.xhr && ut('xhr', ur),
          this.V.fetch && ut('fetch', ar),
          this.V.history && ut('history', cr);
      }),
      (t.id = 'Breadcrumbs'),
      t
    );
  ...
  function or(t) {
    ...
    if ('assert' === t.level) {
      ...
      (n.message = 'Assertion failed: ' + (U(t.args.slice(1), ' ') || 'console.assert')),
  ...
  function ur(t) {
    if (t.endTimestamp) {
      ...
      var n = t.xhr.__sentry_xhr__ || {},
        ...
        o = n.body;
      Jt().addBreadcrumb(
        { category: 'xhr', data: { method: r, url: e, status_code: i }, type: 'http' },
        { xhr: t.xhr, input: o },
      );
    } else;
  }
  function ar(n) {
    n.endTimestamp &&
      ((n.fetchData.url.match(/sentry_key/) && 'POST' === n.fetchData.method) ||
        (n.error
          ? Jt().addBreadcrumb(
              { category: 'fetch', data: n.fetchData, level: t.Severity.Error, type: 'http' },
              { data: n.error, input: n.args },
            )
          : Jt().addBreadcrumb(
              { category: 'fetch', data: i(i({}, n.fetchData), { status_code: n.response.status }), type: 'http' },
  ...
  function cr(t) {
    var n = s(),
      r = t.from,
      e = t.to,
      i = yt(n.location.href),
      o = yt(r),
      u = yt(e);
    o.path || (o = i),
      i.protocol === u.protocol && i.host === u.host && (e = u.relative),
      i.protocol === o.protocol && i.host === o.host && (r = o.relative),
      Jt().addBreadcrumb({ category: 'navigation', data: { from: r, to: e } });
  }
  var sr = (function () {
    function t(n) {
      void 0 === n && (n = {}), (this.name = t.id), (this.Ct = n.key || 'cause'), (this.Lt = n.limit || 5);
    }
    return (
      (t.prototype.setupOnce = function () {
        qt(function (n, r) {
          var e = Jt().getIntegration(t);
          return e
            ? (function (t, n, r, e) {
                if (!(r.exception && r.exception.values && e && x(e.originalException, Error))) return r;
                var i = (function t(n, r, e, i) {
                  void 0 === i && (i = []);
                  if (!x(r[e], Error) || i.length + 1 >= n) return i;
                  var o = xn(mn(r[e]));
                  return t(n, r[e], e, a([o], i));
                })(n, e.originalException, t);
                return (r.exception.values = a(i, r.exception.values)), r;
              })(e.Ct, e.Lt, n, r)
            : n;
        });
      }),
  ...
  var fr = s(),
    hr = (function () {
      ...
      return (
        (t.prototype.setupOnce = function () {
          qt(function (n) {
            if (Jt().getIntegration(t)) {
              if (!fr.navigator && !fr.location && !fr.document) return n;
              var r = (n.request && n.request.url) || (fr.location && fr.location.href),
                e = (fr.document || {}).referrer,
                o = (fr.navigator || {}).userAgent,
                u = i(i(i({}, n.request && n.request.headers), e && { Referer: e }), o && { 'User-Agent': o }),
                a = i(i({}, r && { url: r }), { headers: u });
              return i(i({}, n), { request: a });
            }
            return n;
          });
        }),
      ...
      function n(n) {
        ...
        return (
          ...
          (n.Ot.sdk = n.Ot.sdk || {
            ...
            packages: [{ name: 'npm:@sentry/browser', version: '6.17.6' }],
            version: '6.17.6',
          }),
          t.call(this, Un, n) || this
        );
      }
      return (
        r(n, t),
        (n.prototype.showReportDialog = function (t) {
          void 0 === t && (t = {}),
            s().document &&
              (this.rt()
                ? Bn(i(i({}, t), { dsn: t.dsn || this.getDsn() }))
                : A.error('Trying to call showReportDialog with Sentry Client disabled'));
        }),
        (n.prototype.ut = function (n, r, e) {
          return (n.platform = n.platform || 'javascript'), t.prototype.ut.call(this, n, r, e);
        }),
        (n.prototype.ft = function (n) {
          var r = this.getIntegration(ir);
          r && r.addSentryBreadcrumb(n), t.prototype.ft.call(this, n);
        }),
        n
      );
    })(tn),
    wr = [new sn(), new an(), new Zn(), new ir(), new Wn(), new sr(), new vr(), new hr()];
  function gr(t) {
    t.startSession({ ignoreDuration: !0 }), t.captureSession();
  }
  var xr = {},
    Er = s();
  Er.Sentry && Er.Sentry.Integrations && (xr = Er.Sentry.Integrations);
  var Sr = i(i(i({}, xr), fn), mr);
  return (
    (t.BrowserClient = br),
    (t.Hub = Ct),
    (t.Integrations = Sr),
    (t.SDK_NAME = 'sentry.javascript.browser'),
    (t.SDK_VERSION = '6.17.6'),
    (t.Scope = It),
    (t.Session = At),
    (t.Transports = Ln),
    ...
    (t.captureMessage = function (t, n) {
      ...
      return Xt(
        ...
        i({ originalException: t, syntheticException: r }, 'string' != typeof n ? { captureContext: n } : void 0),
      );
    }),
    (t.close = function (t) {
      var n = Jt().getClient();
    ...
    (t.defaultIntegrations = wr),
    (t.eventFromException = kn),
    (t.eventFromMessage = _n),
    (t.flush = function (t) {
      var n = Jt().getClient();
    ...
    (t.init = function (t) {
      if (
        (void 0 === t && (t = {}),
        void 0 === t.defaultIntegrations && (t.defaultIntegrations = wr),
        void 0 === t.release)
      ) {
        var n = s();
    ...
    (t.showReportDialog = function (t) {
      ...
      var n = Jt(),
        r = n.getScope();
      r && (t.user = i(i({}, r.getUser()), t.user)), t.eventId || (t.eventId = n.lastEventId());
      var e = n.getClient();
      e && e.showReportDialog(t);
    }),
    (t.startTransaction = function (t, n) {
      return Xt('startTransaction', i({}, t), n);
    }),
    (t.withScope = Bt),
    (t.wrap = function (t) {
      return Xn(t)();
